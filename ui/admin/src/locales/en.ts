export default {
  ...
  js_challenge: {
    ...
    enabled: 'ENABLED',
    mode: 'MODE',
    mode_desc: 'Suspicious: only challenge IPs with high threat score. All: challenge every new visitor.',
    mode_off: 'Off',
    mode_suspicious: 'Suspicious Only',
    mode_all: 'All Visitors',
    difficulty: 'DIFFICULTY',
    difficulty_desc: 'Higher values require more computation. 4 is recommended for most use cases.',
    verifying: 'Verifying your browser...',
    please_wait: 'This process is automatic. Your browser will be redirected shortly.',
  },
  webhook: {
    title: 'WEBHOOK',
