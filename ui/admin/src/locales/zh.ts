export default {
  ...
  user: {
    ...
    authorized_domains_hint:
      "逗号分隔的域名模式。支持通配符 (*.example.com)。留空表示不限制访问。",
    authorized_domains_invalid:
      "域名格式无效（例如 example.com 或 *.example.com）",
    unrestricted: "<不限制>",
  ...
  js_challenge: {
    ...
    mode: "模式",
    mode_desc:
      "仅可疑：仅对威胁评分较高的IP发起验证。所有访客：对每个新访客发起验证。",
    mode_off: "关闭",
    mode_suspicious: "仅可疑",
    mode_all: "所有访客",
    difficulty: "难度",
  ...
  waf: {
    ...
    action_redirect: "重定向",
    action_challenge: "验证",
    action_rate_limit: "限速",
    rules_tab: "规则",
    exclusions_tab: "排除规则",
    new_exclusion: "[ 新增排除 ]",
    title_create_exclusion: "新增排除",
    exclusion_path: "路径",
    exclusion_operator: "匹配方式",
    exclusion_rule_id: "规则ID",
    exclusion_all_rules: "所有规则",
    delete_exclusion_confirm: "删除排除规则 {path}?",
    filter_group: "按分组筛选",
    all_groups: "所有分组",
    enable_group: "启用分组",
    disable_group: "禁用分组",
    priority_hint: "数字越小优先级越高",
    rate_limit_hint: "请求数/分钟",
  },
  bot: {
    new_signature: "[ 新增签名 ]",
    name: "名称",
    ...
    action: "动作",
    enabled: "启用",
    delete_confirm: "删除签名 {name}?",
    title_create: "创建签名",
    title_edit: "编辑签名",
    target_ua: "User-Agent",
    target_header: "请求头",
    target_behavior: "行为",
    category_malicious: "恶意",
    category_search_engine: "搜索引擎",
    category_good_bot: "友好Bot",
    action_allow: "允许",
    action_block: "拦截",
    action_challenge: "验证",
    action_monitor: "监控",
    ...
    challenge_escalation: "挑战升级",
    challenge_escalation_desc:
      "根据威胁评分自动升级：低分使用 JS PoW，高分(>=60)使用验证码，极高分(>=90)直接阻止。",
    desc: "通过签名匹配、搜索引擎验证和挑战升级进行Bot检测。",
  },
  access_log: {
    client_ip: "客户端IP",
    method: "方法",
  ...
  system: {
    ...
    headers_desc:
      "配置用于认证的 HTTP 请求头名称。修改后需要同步更新所有客户端。",
    git_token_header: "GIT_TOKEN 请求头",
    license_header: "许可证请求头",
    save: "[ 保存 ]",
    reset: "[ 重置 ]",
    section_semantic_analysis: "语义分析",
    semantic_analysis_enabled: "启用语义分析",
    semantic_analysis_desc: "使用词法分析和指纹匹配检测 SQLi/XSS 攻击。减少正则规则的误报并捕获绕过正则的攻击。",
    section_cache: "缓存管理",
    cache_desc: "清除服务端所有缓存。如果修改配置后数据未更新，可使用此功能。",
    clear_cache: "[ 清除所有缓存 ]",
    clear_cache_confirm:
      "将清除服务端所有缓存，服务会在下次请求时自动重建。是否继续？",
    cache_cleared: "所有缓存已清除",
    section_bot_protection: "机器人防护",
    bot_protection_desc:
      "通过 JS 工作量证明挑战和基于签名的机器人检测（支持 CAPTCHA 升级）保护网站免受自动化流量攻击。",
    section_bot_detection: "机器人检测",
    bot_detection_desc:
      "基于签名的机器人检测。匹配的机器人可被阻止、监控或挑战（JS PoW 或通过升级使用验证码）。",
    section_bot_management: "机器人管理",
    bot_management_desc: "机器人检测和验证码挑战配置，用于自动化流量管理。",
    bot_management_enabled: "启用",
    challenge_escalation: "挑战升级",
    challenge_escalation_desc:
      "根据威胁评分自动升级：低分使用 JS PoW，高分(>=60)使用验证码，极高分(>=90)直接阻止。",
