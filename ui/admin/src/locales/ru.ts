export default {
  ...
  ip_list: {
    ...
    remark_placeholder: 'Необязательная заметка (напр. автобан, подозрительная активность)',
    auto_banned: 'АВТОБАН',
  },
  security_events: {
  ...
  js_challenge: {
    ...
    enabled: 'ВКЛЮЧЕНО',
    mode: 'РЕЖИМ',
    mode_desc: 'Подозрительные: проверять только IP с высоким уровнем угрозы. Все: проверять каждого нового посетителя.',
    mode_off: 'Выключено',
    mode_suspicious: 'Только подозрительные',
    mode_all: 'Все посетители',
    difficulty: 'СЛОЖНОСТЬ',
    difficulty_desc: 'Более высокие значения требуют больше вычислений. 4 рекомендуется для большинства случаев.',
    verifying: 'Проверка вашего браузера...',
    please_wait: 'Этот процесс автоматический. Ваш браузер будет перенаправлен в ближайшее время.',
  },
  webhook: {
    title: 'WEBHOOK',
