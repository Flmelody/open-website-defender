export default {
  ...
  js_challenge: {
    ...
    enabled: 'AKTIVIERT',
    mode: 'MODUS',
    mode_desc: 'Verdächtig: Nur IPs mit hohem Bedrohungswert herausfordern. Alle: Jeden neuen Besucher herausfordern.',
    mode_off: 'Aus',
    mode_suspicious: 'Nur verdächtige',
    mode_all: 'Alle Besucher',
    difficulty: 'SCHWIERIGKEIT',
    difficulty_desc: 'Höhere Werte erfordern mehr Rechenleistung. 4 wird für die meisten Anwendungsfälle empfohlen.',
    verifying: 'Überprüfung Ihres Browsers...',
    please_wait: 'Dieser Vorgang ist automatisch. Ihr Browser wird in Kürze weitergeleitet.',
  },
  webhook: {
    title: 'WEBHOOK',
